...
```bash
socialsyncs integrations:settings youtube-def456
```
...
```bash
socialsyncs integrations:settings twitter-ghi789
```
...
```bash
socialsyncs integrations:settings linkedin-jkl012
```
...
```bash
socialsyncs integrations:settings tiktok-mno345
```
...
```bash
socialsyncs integrations:settings instagram-pqr678
```
...
```bash
socialsyncs integrations:settings threads-stu901
```
...
socialsyncs integrations:settings reddit-456
```
...
```bash
socialsyncs integrations:settings twitter-789 | jq '.output.maxLength'
# Output: 280
```
...
socialsyncs integrations:settings reddit-123 | jq '.output.settings'

# Extract specific field properties
socialsyncs integrations:settings reddit-123 \
...
SETTINGS=$(socialsyncs integrations:settings reddit-123)
...
```bash
socialsyncs integrations:settings invalid-id
