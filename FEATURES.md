# SocialSyncs CLI - Feature Summary

## ✅ Complete Feature Set

### Posts with Comments and Media - FULLY SUPPORTED

The SocialSyncs CLI **fully supports** the complete API structure including:
...
socialsyncs posts:create -c "Post" --image "img1.jpg,img2.jpg,img3.jpg" -i "twitter-123"

# With comments (no custom media per comment)
socialsyncs posts:create -c "Main" --comments "Comment 1;Comment 2" -i "twitter-123"
```
...
- ✅ Fully compatible with the SocialSyncs API structure

The CLI supports the **complete SocialSyncs API** including all advanced features!
