...
# SocialSyncs CLI - Command Line Examples
# Demonstrating the new -c and -m flag syntax

echo "🚀 SocialSyncs CLI Command Line Examples"
echo ""
...
echo "Command:"
echo 'socialsyncs posts:create -c "Hello World!" -i "twitter-123"'
echo ""

# Example 2: Post with multiple images
echo "📸 Example 2: Post with multiple images"
echo "Command:"
echo 'socialsyncs posts:create \'
...
echo "Command:"
echo 'socialsyncs posts:create \'
echo '  -c "🧵 How to use SocialSyncs CLI (1/5)" \'
